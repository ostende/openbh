...
<<<<<<< HEAD
		["Iptv-Player", "enigma2-plugin-extensions-iptvplayer"],
		["Ts-Media", "enigma2-plugin-extensions-tsmedia"],
		["Kodi-Lite", "enigma2-plugin-extensions-kodilite"],
=======
...
<<<<<<< HEAD
			self.pluglist.append(["Kodi Launcher", "enigma2-plugin-extensions-kodi"])	
=======
