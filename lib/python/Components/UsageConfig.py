...
from Tools.Directories import resolveFilename, SCOPE_HDD, SCOPE_TIMESHIFT, SCOPE_VOD, defaultRecordingLocation
...
#GML:2
	...
	config.timeshift.startdelay = ConfigSelection(default = "5", choices = choicelist)
